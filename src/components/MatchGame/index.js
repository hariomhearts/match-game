...
class MatchGame extends Component {
  ...
  render() {
    const {isTrue, category, imgUrl, time, score} = this.state
    const thumbList = imagesList.filter(each => each.category === category)
    return (
      <div className="main-container">
        <nav className="match-game-navbar-section">
          <img
          ...
          <ul className="score-div">
            <li className="score-name-div">
              <p className="score-name">
                score: <span className="score">{score}</span>
              </p>
            </li>
            <li className="score-time-div">
              <img
                src="https://assets.ccbp.in/frontend/react-js/match-game-timer-img.png"
                alt="timer"
                className="score-timer-img"
              />
              <p className=" score-name score">{time} sec</p>
            </li>
          </ul>
        </nav>
        <div className="div-section">
          {!isTrue && (
            <div className="div-game-section">
              ...
              <ul className="tabs-section-name">
                {tabsList.map(each => (
                  <li>
                    <button
              ...
              <ul className="tab-list-img">
                {thumbList.map(eachImg => (
                  <li>
                    <button
                      type="button"
                      className="btn-thumb-img"
          ...
          {isTrue && (
            <div className="div-section-game-over">
              <img
